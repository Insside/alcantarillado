...
?>
<style>
  #divSolicitud{font-family: ''Arial''; font-size: 20px; position:  relative;  border: 1px; border-color:  #CCCCCC; width: 620px; }
  #divSolicitud p{font-family: ''Arial''; font-size: 16px;  line-height: 15px;}
